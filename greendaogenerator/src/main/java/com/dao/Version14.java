...
/**
 * Created by ankitmaheshwari on 12/14/17.
 */

public class Version14 extends SchemaVersion {

    public Version14(boolean current) {
        super(current);
    ...
    private static void addWorkoutData(Schema schema) {
        ...
        workout.addIntProperty("causeId");
        workout.addDoubleProperty("estimatedDistance");
