...
/**
 * This fragment is not being used right now
 * Created by ankitmaheshwari on 1/10/18.
 */

public class WebFeedFragment extends BaseFragment {
    ...
    public static WebFeedFragment newInstance(String url) {
        Bundle args = new Bundle();
        args.putString(KEY_URL, url);
        WebFeedFragment fragment = new WebFeedFragment();
