...
//					sac.setText(ClientConfig.getInstance().SOURCE_ACCEPTABLE_ACCURACY + "");
...
//					ta.setText(ClientConfig.getInstance().THRESHOLD_ACCURACY + "");
...
//					vti.setText(ClientConfig.getInstance().VIGILANCE_TIMER_INTERVAL + "");
...
//						ClientConfig.getInstance().VIGILANCE_TIMER_INTERVAL = Long.parseLong(evti.getText().toString());
//						break;
//					case R.id.edit_too_slow_check:
