...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        achievedTitleDaoConfig = daoConfigMap.get(AchievedTitleDao.class).clone();
        achievedTitleDaoConfig.initIdentityScope(type);
        ...
        achievedTitleDao = new AchievedTitleDao(achievedTitleDaoConfig, this);
    ...
    public void clear() {
        ...
        achievedTitleDaoConfig.getIdentityScope().clear();
