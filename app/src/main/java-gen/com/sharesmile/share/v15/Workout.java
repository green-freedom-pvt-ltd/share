...
public class Workout {
    ...
    public Workout(Long id, float distance, String elapsedTime, Integer steps, float recordedTime, float avgSpeed, String causeBrief, java.util.Date date, Float runAmount, Boolean is_sync, String workoutId, Double startPointLatitude, Double startPointLongitude, Double endPointLatitude, Double endPointLongitude, Long beginTimeStamp, Long endTimeStamp, Boolean isValidRun, Long version, Double calories, Integer teamId, Integer numSpikes, Integer numUpdates, String appVersion, Integer osVersion, String deviceId, String deviceName, Boolean shouldSyncLocationData, Integer causeId, Double estimatedDistance, Integer estimatedSteps, Double estimatedCalories, Integer googleFitStepCount, Double googleFitDistance, Integer usainBoltCount) {
        this.id = id;
        ...
        this.shouldSyncLocationData = shouldSyncLocationData;
    ...
    public Boolean getShouldSyncLocationData() {
        return shouldSyncLocationData;
    }

    public void setShouldSyncLocationData(Boolean shouldSyncLocationData) {
        this.shouldSyncLocationData = shouldSyncLocationData;
    }
    ...
    public void setEstimatedSteps(Integer estimatedSteps) {
        this.estimatedSteps = estimatedSteps;
    }
    ...
    public void setGoogleFitStepCount(Integer googleFitStepCount) {
        this.googleFitStepCount = googleFitStepCount;
    }
    ...
    public void setUsainBoltCount(Integer usainBoltCount) {
        this.usainBoltCount = usainBoltCount;
    }
