...
import com.sharesmile.share.v15.Workout;
...
public class WorkoutDao extends AbstractDao<Workout, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property EstimatedDistance = new Property(29, Double.class, "estimatedDistance", false, "ESTIMATED_DISTANCE");
        public final static Property EstimatedSteps = new Property(30, Integer.class, "estimatedSteps", false, "ESTIMATED_STEPS");
        public final static Property EstimatedCalories = new Property(31, Double.class, "estimatedCalories", false, "ESTIMATED_CALORIES");
        public final static Property GoogleFitStepCount = new Property(32, Integer.class, "googleFitStepCount", false, "GOOGLE_FIT_STEP_COUNT");
        public final static Property GoogleFitDistance = new Property(33, Double.class, "googleFitDistance", false, "GOOGLE_FIT_DISTANCE");
        public final static Property UsainBoltCount = new Property(34, Integer.class, "usainBoltCount", false, "USAIN_BOLT_COUNT");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WORKOUT\" (" + //
                ...
                "\"ESTIMATED_DISTANCE\" REAL," + // 29: estimatedDistance
                "\"ESTIMATED_STEPS\" INTEGER," + // 30: estimatedSteps
                "\"ESTIMATED_CALORIES\" REAL," + // 31: estimatedCalories
                "\"GOOGLE_FIT_STEP_COUNT\" INTEGER," + // 32: googleFitStepCount
                "\"GOOGLE_FIT_DISTANCE\" REAL," + // 33: googleFitDistance
                "\"USAIN_BOLT_COUNT\" INTEGER);"); // 34: usainBoltCount
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, Workout entity) {
        ...
        Double estimatedDistance = entity.getEstimatedDistance();
        if (estimatedDistance != null) {
            stmt.bindDouble(30, estimatedDistance);
        }
 
        Integer estimatedSteps = entity.getEstimatedSteps();
        if (estimatedSteps != null) {
            stmt.bindLong(31, estimatedSteps);
        }
 
        Double estimatedCalories = entity.getEstimatedCalories();
        if (estimatedCalories != null) {
            stmt.bindDouble(32, estimatedCalories);
        }
 
        Integer googleFitStepCount = entity.getGoogleFitStepCount();
        if (googleFitStepCount != null) {
            stmt.bindLong(33, googleFitStepCount);
        }
 
        Double googleFitDistance = entity.getGoogleFitDistance();
        if (googleFitDistance != null) {
            stmt.bindDouble(34, googleFitDistance);
        }
 
        Integer usainBoltCount = entity.getUsainBoltCount();
        if (usainBoltCount != null) {
            stmt.bindLong(35, usainBoltCount);
        }
    }
    ...
    public Workout readEntity(Cursor cursor, int offset) {
        Workout entity = new Workout( //
            ...
            cursor.isNull(offset + 29) ? null : cursor.getDouble(offset + 29), // estimatedDistance
            cursor.isNull(offset + 30) ? null : cursor.getInt(offset + 30), // estimatedSteps
            cursor.isNull(offset + 31) ? null : cursor.getDouble(offset + 31), // estimatedCalories
            cursor.isNull(offset + 32) ? null : cursor.getInt(offset + 32), // googleFitStepCount
            cursor.isNull(offset + 33) ? null : cursor.getDouble(offset + 33), // googleFitDistance
            cursor.isNull(offset + 34) ? null : cursor.getInt(offset + 34) // usainBoltCount
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Workout entity, int offset) {
        ...
        entity.setEstimatedDistance(cursor.isNull(offset + 29) ? null : cursor.getDouble(offset + 29));
        entity.setEstimatedSteps(cursor.isNull(offset + 30) ? null : cursor.getInt(offset + 30));
        entity.setEstimatedCalories(cursor.isNull(offset + 31) ? null : cursor.getDouble(offset + 31));
        entity.setGoogleFitStepCount(cursor.isNull(offset + 32) ? null : cursor.getInt(offset + 32));
        entity.setGoogleFitDistance(cursor.isNull(offset + 33) ? null : cursor.getDouble(offset + 33));
        entity.setUsainBoltCount(cursor.isNull(offset + 34) ? null : cursor.getInt(offset + 34));
     }
