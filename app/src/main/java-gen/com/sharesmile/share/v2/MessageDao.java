...
public class MessageDao extends AbstractDao<Message, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Is_read = new Property(7, Boolean.class, "is_read", false, "IS_READ");
    };
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getShort(offset + 7) != 0 // is_read
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setIs_read(cursor.isNull(offset + 7) ? null : cursor.getShort(offset + 7) != 0);
     }
