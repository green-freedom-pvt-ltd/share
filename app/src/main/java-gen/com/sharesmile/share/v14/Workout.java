...
public class Workout {
    ...
    public Workout(Long id, float distance, String elapsedTime, Integer steps, float recordedTime, float avgSpeed, String causeBrief, java.util.Date date, Float runAmount, Boolean is_sync, String workoutId, Double startPointLatitude, Double startPointLongitude, Double endPointLatitude, Double endPointLongitude, Long beginTimeStamp, Long endTimeStamp, Boolean isValidRun, Long version, Double calories, Integer teamId, Integer numSpikes, Integer numUpdates, String appVersion, Integer osVersion, String deviceId, String deviceName, Boolean shouldSyncLocationData, Integer causeId, Double estimatedDistance, Integer estimatedSteps, Double estimatedCalories, Integer googleFitStepCount, Double googleFitDistance) {
        this.id = id;
